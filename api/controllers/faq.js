        ...
        'categories' : [
            {
                ...
                "questions" :[
                    ...
                    {
                        "title" : "2．提高产能会占用总投资预算么",
                        answer : "不会。增加产能的成本不会占用总投资预算。"
                    },
                    {
                        "title" : "3．提高生产灵活性有什么好处",
            ...
            },
            {
                ...
                "questions" :[
                    {
                        "title" : "1．为什么现阶段的出厂价和上阶段一致，提示信息却显示“错误、超过输入范围”？",
            ...
            },
            {
                ...
                "questions" :[
                    {
                        "title" : "1．为什么预算状态条显示还有预算，却无法增加投资额？",
                        "answer" : "请检查“预算使用信息”，以预算使用信息表内的“预计剩余预算”为准。"
                    },
                    {
                        "title" : "2．为什么明明减少了投资预算，预算状态条和“预计剩余预算”一栏却没有变化？",
                        "answer" : "请关闭所有窗口，重新打开，即可获得更新后的剩余预算。"
                    },
                    {
                        "title" : "3．如果公司赢利，赢利部分会增加总投资预算吗？",
                        "answer" : "不能。每家公司的总投资预算都一样，赢利部分不能增加既定的总投资预算，但是会增加公司的累计赢利。"
                    },
                    {
                        "title" : "4．为什么上阶段预算和本阶段的实际报告有出入？",
                    ...
                    {
                        "title" : "5．为什么预算状态条显示预算基本用完，下阶段打开决策时却显示预算增加了？",
            ...
            },
            {
                ...
                "questions" :[
                    ...
                    {
                        "title" : "2．零售终端费用具体指什么？和零售终端让利有什么区别？",
