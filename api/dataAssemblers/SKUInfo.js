...
exports.getSKUInfo = function(seminarId, currentPeriod, companyId, SKUID){
    ...
    return Q.all([
        ...
        var unitProductionCost=utility.unitCost(currentPeriod,SKUResult.u_PackSize,decision.d_IngredientsQuality,decision.d_Technology,companyResult.c_CumulatedProductionVolumes,companyResult.c_AcquiredEfficiency,decision.d_ProductionVolume);
