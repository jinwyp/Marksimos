...
exports.getCompetitorIntelligenceReport = function(allResults){
    return {
        ...
        inventoryVolumeAtManufactuerStdPack: companyReport(allResults, function(companyResult){return companyResult.c_FactoryStocks[consts.StocksMaxTotal].s_Volume}),
