...
exports.getFinancialReport = function(allResults){
    ...
    allCompanyReport.forEach(function(companyReport){
        allResults.forEach(function(onePeriodResult){
            ...
            reportByBrand.data = reportForBrand(onePeriodResult, companyReport.companyId);
            reportByBrand.data.push(reportForCompanyTotal(onePeriodResult, companyReport.companyId));
