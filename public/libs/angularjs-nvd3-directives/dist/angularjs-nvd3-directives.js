...
( function () {
  ...
  ]).directive('nvd3ScatterChartMarksimos', [
    function() {
        return {
            restrict: 'EA',
            scope: {
                ...
                scope.$watch('data', function(data) {
                    if (data) {
                        ...
                        nv.addGraph({
                            generate: function() {
                                initializeMargin(scope, attrs);
                                var chart = nv.models.scatterChartMarksimos().width(scope.width).height(scope.height).margin(scope.margin).x(attrs.x === undefined ? function(d) {
                                    return d.x;
                                } : scope.x()).y(attrs.y === undefined ? function(d) {
                                    return d.y;
                                } : scope.y()).size(attrs.size === undefined ? function(d) {
